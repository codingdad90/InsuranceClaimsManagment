...
namespace MAKClaims.Models
{
    ...
    public partial class Claimsconfig : DbContext
    {
        public Claimsconfig()
            : base("name=Claimsconfig")
        {
        }
        ...
        public virtual ObjectResult<GetUserRoleByUserId_Result> GetUserRoleByUserId(string userId)
        {
        ...
        public virtual int FN_GetUserRoleByUserId1(string userId)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FN_GetUserRoleByUserId1", userIdParameter);
        }
    }
}
