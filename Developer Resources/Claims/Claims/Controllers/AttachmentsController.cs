...
namespace Claims.Controllers
{
    public class AttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AttachmentId,Attachment1,ClaimActionId")] Attachment attachment)
        {
            ...
            ViewBag.ClaimActionId = new SelectList(db.ClaimActions, "ClaimActionId", "Note", attachment.ClaimActionId);
            return View(attachment);
        }
